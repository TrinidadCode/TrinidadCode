...
document.getElementById("login-div").style.display="none";
document.getElementById("result-box").innerHTML= "Welcome to TrinidadCode!"+loginEmail+ "was Login Successfully";
...
document.getElementById("result-box").style.display="inline";
document.getElementById("register-div").style.display="none";
document.getElementById("result-box").innerHTML= "Welcome "+registerEmail+ "was Registered Successfully";
